...
export const canisterId = process.env.CANISTER_ID_GEOHASH;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./geohash.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the geohash canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./geohash.did.js")._SERVICE>}
 */
export const geohash = createActor(canisterId);
